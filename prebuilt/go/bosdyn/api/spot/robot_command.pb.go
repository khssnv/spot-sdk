...
type MobilityParams struct {
	...
	DisableStairErrorAutoDescent bool `protobuf:"varint,16,opt,name=disable_stair_error_auto_descent,json=disableStairErrorAutoDescent,proto3" json:"disable_stair_error_auto_descent,omitempty"`
...
func (x *MobilityParams) GetDisableStairErrorAutoDescent() bool {
	if x != nil {
		return x.DisableStairErrorAutoDescent
	}
	return false
}
...
type BodyControlParams struct {
	...
	//	*BodyControlParams_BaseOffsetRtFootprint
	//	*BodyControlParams_BodyAssistForManipulation_
	Param isBodyControlParams_Param `protobuf_oneof:"param"`
...
func (m *BodyControlParams) GetParam() isBodyControlParams_Param {
	if m != nil {
		return m.Param
	}
	return nil
...
func (x *BodyControlParams) GetBaseOffsetRtFootprint() *api.SE3Trajectory {
	if x, ok := x.GetParam().(*BodyControlParams_BaseOffsetRtFootprint); ok {
		return x.BaseOffsetRtFootprint
	}
	return nil
}

func (x *BodyControlParams) GetBodyAssistForManipulation() *BodyControlParams_BodyAssistForManipulation {
	if x, ok := x.GetParam().(*BodyControlParams_BodyAssistForManipulation_); ok {
		return x.BodyAssistForManipulation
	}
	return nil
}
...
type isBodyControlParams_Param interface {
	isBodyControlParams_Param()
}

type BodyControlParams_BaseOffsetRtFootprint struct {
	...
	BaseOffsetRtFootprint *api.SE3Trajectory `protobuf:"bytes,1,opt,name=base_offset_rt_footprint,json=baseOffsetRtFootprint,proto3,oneof"`
}

type BodyControlParams_BodyAssistForManipulation_ struct {
	...
	// and orientation.
	BodyAssistForManipulation *BodyControlParams_BodyAssistForManipulation `protobuf:"bytes,3,opt,name=body_assist_for_manipulation,json=bodyAssistForManipulation,proto3,oneof"`
}

func (*BodyControlParams_BaseOffsetRtFootprint) isBodyControlParams_Param() {}

func (*BodyControlParams_BodyAssistForManipulation_) isBodyControlParams_Param() {}
...
// hvae no effect.
type BodyControlParams_BodyAssistForManipulation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Enable the use of body yaw to assist with manipulation.
	EnableBodyYawAssist bool `protobuf:"varint,1,opt,name=enable_body_yaw_assist,json=enableBodyYawAssist,proto3" json:"enable_body_yaw_assist,omitempty"`
	// Enable use of hip height (e.g. body height/pitch) to assist with manipulation.
	EnableHipHeightAssist bool `protobuf:"varint,2,opt,name=enable_hip_height_assist,json=enableHipHeightAssist,proto3" json:"enable_hip_height_assist,omitempty"`
}

func (x *BodyControlParams_BodyAssistForManipulation) Reset() {
	*x = BodyControlParams_BodyAssistForManipulation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_bosdyn_api_spot_robot_command_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *BodyControlParams_BodyAssistForManipulation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BodyControlParams_BodyAssistForManipulation) ProtoMessage() {}

func (x *BodyControlParams_BodyAssistForManipulation) ProtoReflect() protoreflect.Message {
	mi := &file_bosdyn_api_spot_robot_command_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BodyControlParams_BodyAssistForManipulation.ProtoReflect.Descriptor instead.
func (*BodyControlParams_BodyAssistForManipulation) Descriptor() ([]byte, []int) {
	return file_bosdyn_api_spot_robot_command_proto_rawDescGZIP(), []int{1, 0}
}

func (x *BodyControlParams_BodyAssistForManipulation) GetEnableBodyYawAssist() bool {
	if x != nil {
		return x.EnableBodyYawAssist
	}
	return false
}

func (x *BodyControlParams_BodyAssistForManipulation) GetEnableHipHeightAssist() bool {
	if x != nil {
		return x.EnableHipHeightAssist
	}
	return false
}
...
var file_bosdyn_api_spot_robot_command_proto_rawDesc = []byte{
	...
	,
...
var file_bosdyn_api_spot_robot_command_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_bosdyn_api_spot_robot_command_proto_goTypes = []interface{}{
	...
	(*BodyControlParams_BodyAssistForManipulation)(nil), // 10: bosdyn.api.spot.BodyControlParams.BodyAssistForManipulation
	(*api.SE2VelocityLimit)(nil),                        // 11: bosdyn.api.SE2VelocityLimit
	(*api.SE3Trajectory)(nil),                           // 12: bosdyn.api.SE3Trajectory
	(*wrapperspb.DoubleValue)(nil),                      // 13: google.protobuf.DoubleValue
	(*api.Vec3)(nil),                                    // 14: bosdyn.api.Vec3
}
var file_bosdyn_api_spot_robot_command_proto_depIdxs = []int32{
	11, // 0: bosdyn.api.spot.MobilityParams.vel_limit:type_name -> bosdyn.api.SE2VelocityLimit
	...
	12, // 7: bosdyn.api.spot.BodyControlParams.base_offset_rt_footprint:type_name -> bosdyn.api.SE3Trajectory
	10, // 8: bosdyn.api.spot.BodyControlParams.body_assist_for_manipulation:type_name -> bosdyn.api.spot.BodyControlParams.BodyAssistForManipulation
	2,  // 9: bosdyn.api.spot.BodyControlParams.rotation_setting:type_name -> bosdyn.api.spot.BodyControlParams.RotationSetting
	13, // 10: bosdyn.api.spot.TerrainParams.ground_mu_hint:type_name -> google.protobuf.DoubleValue
	3,  // 11: bosdyn.api.spot.TerrainParams.grated_surfaces_mode:type_name -> bosdyn.api.spot.TerrainParams.GratedSurfacesMode
	4,  // 12: bosdyn.api.spot.BodyExternalForceParams.external_force_indicator:type_name -> bosdyn.api.spot.BodyExternalForceParams.ExternalForceIndicator
	14, // 13: bosdyn.api.spot.BodyExternalForceParams.external_force_override:type_name -> bosdyn.api.Vec3
...
func file_bosdyn_api_spot_robot_command_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bosdyn_api_spot_robot_command_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BodyControlParams_BodyAssistForManipulation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_bosdyn_api_spot_robot_command_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*BodyControlParams_BaseOffsetRtFootprint)(nil),
		(*BodyControlParams_BodyAssistForManipulation_)(nil),
	}
	type x struct{}
