...
type SelfRightCommand_Feedback_Status int32

const (
	SelfRightCommand_Feedback_STATUS_UNKNOWN SelfRightCommand_Feedback_Status = 0
	// Self-right has completed
	SelfRightCommand_Feedback_STATUS_COMPLETED SelfRightCommand_Feedback_Status = 1
	// Robot is in progress of attempting to self-right
	SelfRightCommand_Feedback_STATUS_IN_PROGRESS SelfRightCommand_Feedback_Status = 2
)

// Enum value maps for SelfRightCommand_Feedback_Status.
var (
	SelfRightCommand_Feedback_Status_name = map[int32]string{
		0: "STATUS_UNKNOWN",
		1: "STATUS_COMPLETED",
		2: "STATUS_IN_PROGRESS",
	}
	SelfRightCommand_Feedback_Status_value = map[string]int32{
		"STATUS_UNKNOWN":     0,
		"STATUS_COMPLETED":   1,
		"STATUS_IN_PROGRESS": 2,
	}
...
func (x SelfRightCommand_Feedback_Status) Enum() *SelfRightCommand_Feedback_Status {
	p := new(SelfRightCommand_Feedback_Status)
	*p = x
	return p
}

func (x SelfRightCommand_Feedback_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SelfRightCommand_Feedback_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_bosdyn_api_basic_command_proto_enumTypes[3].Descriptor()
}

func (SelfRightCommand_Feedback_Status) Type() protoreflect.EnumType {
	return &file_bosdyn_api_basic_command_proto_enumTypes[3]
}

func (x SelfRightCommand_Feedback_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SelfRightCommand_Feedback_Status.Descriptor instead.
func (SelfRightCommand_Feedback_Status) EnumDescriptor() ([]byte, []int) {
	return file_bosdyn_api_basic_command_proto_rawDescGZIP(), []int{2, 1, 0}
}
...
type SafePowerOffCommand_Request_UnsafeAction int32

const (
	SafePowerOffCommand_Request_UNSAFE_UNKNOWN SafePowerOffCommand_Request_UnsafeAction = 0
	// Robot may attempt to move to a safe position (i.e. descends stairs) before sitting
	// and powering off.
	SafePowerOffCommand_Request_UNSAFE_MOVE_TO_SAFE_POSITION SafePowerOffCommand_Request_UnsafeAction = 1
	// Force sit and power off regardless of positioning. Robot will not take additional steps
	SafePowerOffCommand_Request_UNSAFE_FORCE_COMMAND SafePowerOffCommand_Request_UnsafeAction = 2
)

// Enum value maps for SafePowerOffCommand_Request_UnsafeAction.
var (
	SafePowerOffCommand_Request_UnsafeAction_name = map[int32]string{
		0: "UNSAFE_UNKNOWN",
		1: "UNSAFE_MOVE_TO_SAFE_POSITION",
		2: "UNSAFE_FORCE_COMMAND",
	}
	SafePowerOffCommand_Request_UnsafeAction_value = map[string]int32{
		"UNSAFE_UNKNOWN":               0,
...
func (x SafePowerOffCommand_Request_UnsafeAction) Enum() *SafePowerOffCommand_Request_UnsafeAction {
	p := new(SafePowerOffCommand_Request_UnsafeAction)
	*p = x
	return p
}

func (x SafePowerOffCommand_Request_UnsafeAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SafePowerOffCommand_Request_UnsafeAction) Descriptor() protoreflect.EnumDescriptor {
	return file_bosdyn_api_basic_command_proto_enumTypes[4].Descriptor()
}

func (SafePowerOffCommand_Request_UnsafeAction) Type() protoreflect.EnumType {
	return &file_bosdyn_api_basic_command_proto_enumTypes[4]
}

func (x SafePowerOffCommand_Request_UnsafeAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SafePowerOffCommand_Request_UnsafeAction.Descriptor instead.
func (SafePowerOffCommand_Request_UnsafeAction) EnumDescriptor() ([]byte, []int) {
	return file_bosdyn_api_basic_command_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
type StandCommand_Feedback_StandingState int32

const (
	// STANDING_UNKNOWN should never be used. If used, an internal error has happened.
	StandCommand_Feedback_STANDING_UNKNOWN StandCommand_Feedback_StandingState = 0
	// Robot is standing up and actively controlling its body so it may occasionally make
	// small body adjustments.
	StandCommand_Feedback_STANDING_CONTROLLED StandCommand_Feedback_StandingState = 1
	...
	// state.
	StandCommand_Feedback_STANDING_FROZEN StandCommand_Feedback_StandingState = 2
)

// Enum value maps for StandCommand_Feedback_StandingState.
var (
	StandCommand_Feedback_StandingState_name = map[int32]string{
		0: "STANDING_UNKNOWN",
		1: "STANDING_CONTROLLED",
		2: "STANDING_FROZEN",
	}
	StandCommand_Feedback_StandingState_value = map[string]int32{
		"STANDING_UNKNOWN":    0,
...
func (x StandCommand_Feedback_StandingState) Enum() *StandCommand_Feedback_StandingState {
	p := new(StandCommand_Feedback_StandingState)
	*p = x
	return p
}

func (x StandCommand_Feedback_StandingState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (StandCommand_Feedback_StandingState) Descriptor() protoreflect.EnumDescriptor {
	return file_bosdyn_api_basic_command_proto_enumTypes[10].Descriptor()
}

func (StandCommand_Feedback_StandingState) Type() protoreflect.EnumType {
	return &file_bosdyn_api_basic_command_proto_enumTypes[10]
}

func (x StandCommand_Feedback_StandingState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StandCommand_Feedback_StandingState.Descriptor instead.
func (StandCommand_Feedback_StandingState) EnumDescriptor() ([]byte, []int) {
	return file_bosdyn_api_basic_command_proto_rawDescGZIP(), []int{9, 1, 1}
}
...
func (ArmDragCommand_Feedback_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_bosdyn_api_basic_command_proto_enumTypes[12].Descriptor()
}

func (ArmDragCommand_Feedback_Status) Type() protoreflect.EnumType {
	return &file_bosdyn_api_basic_command_proto_enumTypes[12]
}
...
func (ConstrainedManipulationCommand_Request_TaskType) Descriptor() protoreflect.EnumDescriptor {
	return file_bosdyn_api_basic_command_proto_enumTypes[13].Descriptor()
}

func (ConstrainedManipulationCommand_Request_TaskType) Type() protoreflect.EnumType {
	return &file_bosdyn_api_basic_command_proto_enumTypes[13]
}
...
func (ConstrainedManipulationCommand_Feedback_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_bosdyn_api_basic_command_proto_enumTypes[14].Descriptor()
}

func (ConstrainedManipulationCommand_Feedback_Status) Type() protoreflect.EnumType {
	return &file_bosdyn_api_basic_command_proto_enumTypes[14]
}
...
type SelfRightCommand_Feedback struct {
	...
	Status SelfRightCommand_Feedback_Status `protobuf:"varint,1,opt,name=status,proto3,enum=bosdyn.api.SelfRightCommand_Feedback_Status" json:"status,omitempty"`
}
...
func (x *SelfRightCommand_Feedback) GetStatus() SelfRightCommand_Feedback_Status {
	if x != nil {
		return x.Status
	}
	return SelfRightCommand_Feedback_STATUS_UNKNOWN
}
...
type SafePowerOffCommand_Request struct {
	...
	UnsafeAction SafePowerOffCommand_Request_UnsafeAction `protobuf:"varint,1,opt,name=unsafe_action,json=unsafeAction,proto3,enum=bosdyn.api.SafePowerOffCommand_Request_UnsafeAction" json:"unsafe_action,omitempty"`
}
...
func (x *SafePowerOffCommand_Request) GetUnsafeAction() SafePowerOffCommand_Request_UnsafeAction {
	if x != nil {
		return x.UnsafeAction
	}
	return SafePowerOffCommand_Request_UNSAFE_UNKNOWN
}
...
type StandCommand_Feedback struct {
	...
	StandingState StandCommand_Feedback_StandingState `protobuf:"varint,2,opt,name=standing_state,json=standingState,proto3,enum=bosdyn.api.StandCommand_Feedback_StandingState" json:"standing_state,omitempty"`
}
...
func (x *StandCommand_Feedback) GetStandingState() StandCommand_Feedback_StandingState {
	if x != nil {
		return x.StandingState
	}
	return StandCommand_Feedback_STANDING_UNKNOWN
}
...
type ConstrainedManipulationCommand_Request struct {
	...
	EnableRobotLocomotion *wrapperspb.BoolValue `protobuf:"bytes,9,opt,name=enable_robot_locomotion,json=enableRobotLocomotion,proto3" json:"enable_robot_locomotion,omitempty"`
}
...
func (x *ConstrainedManipulationCommand_Request) GetEnableRobotLocomotion() *wrapperspb.BoolValue {
	if x != nil {
		return x.EnableRobotLocomotion
	}
	return nil
}
...
var file_bosdyn_api_basic_command_proto_rawDesc = []byte{
	...
	0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x22, 0xbc, 0x01, 0x0a, 0x10, 0x53,
	0x65, 0x6c, 0x66, 0x52, 0x69, 0x67, 0x68, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x1a,
	0x09, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x9c, 0x01, 0x0a, 0x08, 0x46,
	0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x12, 0x44, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x62, 0x6f, 0x73, 0x64, 0x79, 0x6e,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x6c, 0x66, 0x52, 0x69, 0x67, 0x68, 0x74, 0x43, 0x6f,
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x2e, 0x53,
	...
	,
	...
	0x4e, 0x5f, 0x50, 0x52, 0x4f, 0x47, 0x52, 0x45, 0x53, 0x53, 0x10, 0x02, 0x22, 0xe3, 0x02, 0x0a,
	0x0c, 0x53, 0x74, 0x61, 0x6e, 0x64, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x1a, 0x09, 0x0a,
	0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0xc7, 0x02, 0x0a, 0x08, 0x46, 0x65, 0x65,
	...
	,
	...
	,
...
var file_bosdyn_api_basic_command_proto_enumTypes = make([]protoimpl.EnumInfo, 15)
...
var file_bosdyn_api_basic_command_proto_goTypes = []interface{}{
	...
	(SelfRightCommand_Feedback_Status)(0),                 // 3: bosdyn.api.SelfRightCommand.Feedback.Status
	(SafePowerOffCommand_Request_UnsafeAction)(0),         // 4: bosdyn.api.SafePowerOffCommand.Request.UnsafeAction
	(SafePowerOffCommand_Feedback_Status)(0),              // 5: bosdyn.api.SafePowerOffCommand.Feedback.Status
	(SE2TrajectoryCommand_Feedback_Status)(0),             // 6: bosdyn.api.SE2TrajectoryCommand.Feedback.Status
	(SE2TrajectoryCommand_Feedback_BodyMovementStatus)(0), // 7: bosdyn.api.SE2TrajectoryCommand.Feedback.BodyMovementStatus
	(SitCommand_Feedback_Status)(0),                       // 8: bosdyn.api.SitCommand.Feedback.Status
	(StandCommand_Feedback_Status)(0),                     // 9: bosdyn.api.StandCommand.Feedback.Status
	(StandCommand_Feedback_StandingState)(0),              // 10: bosdyn.api.StandCommand.Feedback.StandingState
	(StanceCommand_Feedback_Status)(0),                    // 11: bosdyn.api.StanceCommand.Feedback.Status
	(ArmDragCommand_Feedback_Status)(0),                   // 12: bosdyn.api.ArmDragCommand.Feedback.Status
	(ConstrainedManipulationCommand_Request_TaskType)(0),  // 13: bosdyn.api.ConstrainedManipulationCommand.Request.TaskType
	(ConstrainedManipulationCommand_Feedback_Status)(0),   // 14: bosdyn.api.ConstrainedManipulationCommand.Feedback.Status
	(*RobotCommandFeedbackStatus)(nil),                    // 15: bosdyn.api.RobotCommandFeedbackStatus
	(*BatteryChangePoseCommand)(nil),                      // 16: bosdyn.api.BatteryChangePoseCommand
	(*SelfRightCommand)(nil),                              // 17: bosdyn.api.SelfRightCommand
	(*StopCommand)(nil),                                   // 18: bosdyn.api.StopCommand
	(*FreezeCommand)(nil),                                 // 19: bosdyn.api.FreezeCommand
	(*SafePowerOffCommand)(nil),                           // 20: bosdyn.api.SafePowerOffCommand
	(*SE2TrajectoryCommand)(nil),                          // 21: bosdyn.api.SE2TrajectoryCommand
	(*SE2VelocityCommand)(nil),                            // 22: bosdyn.api.SE2VelocityCommand
	(*SitCommand)(nil),                                    // 23: bosdyn.api.SitCommand
	(*StandCommand)(nil),                                  // 24: bosdyn.api.StandCommand
	(*StanceCommand)(nil),                                 // 25: bosdyn.api.StanceCommand
	(*Stance)(nil),                                        // 26: bosdyn.api.Stance
	(*FollowArmCommand)(nil),                              // 27: bosdyn.api.FollowArmCommand
	(*ArmDragCommand)(nil),                                // 28: bosdyn.api.ArmDragCommand
	(*ConstrainedManipulationCommand)(nil),                // 29: bosdyn.api.ConstrainedManipulationCommand
	(*BatteryChangePoseCommand_Request)(nil),              // 30: bosdyn.api.BatteryChangePoseCommand.Request
	(*BatteryChangePoseCommand_Feedback)(nil),             // 31: bosdyn.api.BatteryChangePoseCommand.Feedback
	(*SelfRightCommand_Request)(nil),                      // 32: bosdyn.api.SelfRightCommand.Request
	(*SelfRightCommand_Feedback)(nil),                     // 33: bosdyn.api.SelfRightCommand.Feedback
	(*StopCommand_Request)(nil),                           // 34: bosdyn.api.StopCommand.Request
	(*StopCommand_Feedback)(nil),                          // 35: bosdyn.api.StopCommand.Feedback
	(*FreezeCommand_Request)(nil),                         // 36: bosdyn.api.FreezeCommand.Request
	(*FreezeCommand_Feedback)(nil),                        // 37: bosdyn.api.FreezeCommand.Feedback
	(*SafePowerOffCommand_Request)(nil),                   // 38: bosdyn.api.SafePowerOffCommand.Request
	(*SafePowerOffCommand_Feedback)(nil),                  // 39: bosdyn.api.SafePowerOffCommand.Feedback
	(*SE2TrajectoryCommand_Request)(nil),                  // 40: bosdyn.api.SE2TrajectoryCommand.Request
	(*SE2TrajectoryCommand_Feedback)(nil),                 // 41: bosdyn.api.SE2TrajectoryCommand.Feedback
	(*SE2VelocityCommand_Request)(nil),                    // 42: bosdyn.api.SE2VelocityCommand.Request
	(*SE2VelocityCommand_Feedback)(nil),                   // 43: bosdyn.api.SE2VelocityCommand.Feedback
	(*SitCommand_Request)(nil),                            // 44: bosdyn.api.SitCommand.Request
	(*SitCommand_Feedback)(nil),                           // 45: bosdyn.api.SitCommand.Feedback
	(*StandCommand_Request)(nil),                          // 46: bosdyn.api.StandCommand.Request
	(*StandCommand_Feedback)(nil),                         // 47: bosdyn.api.StandCommand.Feedback
	(*StanceCommand_Request)(nil),                         // 48: bosdyn.api.StanceCommand.Request
	(*StanceCommand_Feedback)(nil),                        // 49: bosdyn.api.StanceCommand.Feedback
	nil,                                                   // 50: bosdyn.api.Stance.FootPositionsEntry
	(*FollowArmCommand_Request)(nil),                      // 51: bosdyn.api.FollowArmCommand.Request
	(*FollowArmCommand_Feedback)(nil),                     // 52: bosdyn.api.FollowArmCommand.Feedback
	(*ArmDragCommand_Request)(nil),                        // 53: bosdyn.api.ArmDragCommand.Request
	(*ArmDragCommand_Feedback)(nil),                       // 54: bosdyn.api.ArmDragCommand.Feedback
	(*ConstrainedManipulationCommand_Request)(nil),        // 55: bosdyn.api.ConstrainedManipulationCommand.Request
	(*ConstrainedManipulationCommand_Feedback)(nil),       // 56: bosdyn.api.ConstrainedManipulationCommand.Feedback
	(*timestamppb.Timestamp)(nil),                         // 57: google.protobuf.Timestamp
	(*SE2Trajectory)(nil),                                 // 58: bosdyn.api.SE2Trajectory
	(*SE2Velocity)(nil),                                   // 59: bosdyn.api.SE2Velocity
	(*Vec2)(nil),                                          // 60: bosdyn.api.Vec2
	(*Vec3)(nil),                                          // 61: bosdyn.api.Vec3
	(*Wrench)(nil),                                        // 62: bosdyn.api.Wrench
...
var file_bosdyn_api_basic_command_proto_depIdxs = []int32{
	50, // 0: bosdyn.api.Stance.foot_positions:type_name -> bosdyn.api.Stance.FootPositionsEntry
	...
	3,  // 3: bosdyn.api.SelfRightCommand.Feedback.status:type_name -> bosdyn.api.SelfRightCommand.Feedback.Status
	4,  // 4: bosdyn.api.SafePowerOffCommand.Request.unsafe_action:type_name -> bosdyn.api.SafePowerOffCommand.Request.UnsafeAction
	5,  // 5: bosdyn.api.SafePowerOffCommand.Feedback.status:type_name -> bosdyn.api.SafePowerOffCommand.Feedback.Status
	57, // 6: bosdyn.api.SE2TrajectoryCommand.Request.end_time:type_name -> google.protobuf.Timestamp
	58, // 7: bosdyn.api.SE2TrajectoryCommand.Request.trajectory:type_name -> bosdyn.api.SE2Trajectory
	6,  // 8: bosdyn.api.SE2TrajectoryCommand.Feedback.status:type_name -> bosdyn.api.SE2TrajectoryCommand.Feedback.Status
	7,  // 9: bosdyn.api.SE2TrajectoryCommand.Feedback.body_movement_status:type_name -> bosdyn.api.SE2TrajectoryCommand.Feedback.BodyMovementStatus
	57, // 10: bosdyn.api.SE2VelocityCommand.Request.end_time:type_name -> google.protobuf.Timestamp
	59, // 11: bosdyn.api.SE2VelocityCommand.Request.velocity:type_name -> bosdyn.api.SE2Velocity
	59, // 12: bosdyn.api.SE2VelocityCommand.Request.slew_rate_limit:type_name -> bosdyn.api.SE2Velocity
	8,  // 13: bosdyn.api.SitCommand.Feedback.status:type_name -> bosdyn.api.SitCommand.Feedback.Status
	9,  // 14: bosdyn.api.StandCommand.Feedback.status:type_name -> bosdyn.api.StandCommand.Feedback.Status
	10, // 15: bosdyn.api.StandCommand.Feedback.standing_state:type_name -> bosdyn.api.StandCommand.Feedback.StandingState
	57, // 16: bosdyn.api.StanceCommand.Request.end_time:type_name -> google.protobuf.Timestamp
	26, // 17: bosdyn.api.StanceCommand.Request.stance:type_name -> bosdyn.api.Stance
	11, // 18: bosdyn.api.StanceCommand.Feedback.status:type_name -> bosdyn.api.StanceCommand.Feedback.Status
	60, // 19: bosdyn.api.Stance.FootPositionsEntry.value:type_name -> bosdyn.api.Vec2
	61, // 20: bosdyn.api.FollowArmCommand.Request.body_offset_from_hand:type_name -> bosdyn.api.Vec3
	12, // 21: bosdyn.api.ArmDragCommand.Feedback.status:type_name -> bosdyn.api.ArmDragCommand.Feedback.Status
	62, // 22: bosdyn.api.ConstrainedManipulationCommand.Request.init_wrench_direction_in_frame_name:type_name -> bosdyn.api.Wrench
	63, // 23: bosdyn.api.ConstrainedManipulationCommand.Request.force_limit:type_name -> google.protobuf.DoubleValue
	63, // 24: bosdyn.api.ConstrainedManipulationCommand.Request.torque_limit:type_name -> google.protobuf.DoubleValue
	13, // 25: bosdyn.api.ConstrainedManipulationCommand.Request.task_type:type_name -> bosdyn.api.ConstrainedManipulationCommand.Request.TaskType
	57, // 26: bosdyn.api.ConstrainedManipulationCommand.Request.end_time:type_name -> google.protobuf.Timestamp
	64, // 27: bosdyn.api.ConstrainedManipulationCommand.Request.enable_robot_locomotion:type_name -> google.protobuf.BoolValue
	14, // 28: bosdyn.api.ConstrainedManipulationCommand.Feedback.status:type_name -> bosdyn.api.ConstrainedManipulationCommand.Feedback.Status
	62, // 29: bosdyn.api.ConstrainedManipulationCommand.Feedback.desired_wrench_odom_frame:type_name -> bosdyn.api.Wrench
